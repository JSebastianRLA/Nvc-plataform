...
function ui_print_status_div($status)
{
    switch ((int) $status) {
        case 0:
            $return = '<div class="status_rounded_rectangles forced_title" style="display: inline-block; background: #24C214;" title="OK" data-title="OK" data-use_title_for_force_title="1">&nbsp;</div>';
            break;
